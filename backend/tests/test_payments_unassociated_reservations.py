...
class TestUnassociatedReservations:
    def test_unassociated_reservations_appear_on_page(
        ...
        assert (
            "reservations without payment" in html.lower()
            or "reservaciones sin pago" in html.lower()
        )
    ...
    def test_empty_state_when_all_associated(
        ...
        html = response.content.decode()
        assert (
            "no tiene reservaciones sin pago" in html.lower()
            or "no reservations" in html.lower()
        )
