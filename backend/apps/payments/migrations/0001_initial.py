        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_identifier",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Payment identifier"
                    ),
                ),
                ("date", models.DateField(verbose_name="Date")),
                (
                    "class_slot_count",
                    models.PositiveSmallIntegerField(verbose_name="Class slot count"),
                ),
                (
                    "reference",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["client", "-date"],
                        name="payments_pa_client__9f874c_idx",
                    ),
                    models.Index(
                        fields=["date", "payment_type"],
                        name="payments_pa_date_12743b_idx",
                    ),
                ],
            },
        ),
