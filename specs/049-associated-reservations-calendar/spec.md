...
**Feature Branch**: `049-associated-reservations-calendar`

**Created**: 2026-07-21

**Status**: Draft

**Input**: User description from `ai/features/todos/21-Associated-reservations-calendar-download.md`
...
- What happens if the payment detail page is loading or unavailable? A loading state or error message should be shown.
...
- The existing icalendar library in the project dependencies can be reused for ICS generation.
- The "Descargar calendario" button is placed near the reservations list on the payment detail page.
