...
Given there are payments of different types on the same day, When the chart renders, Then each payment type is represented by a distinct color in the stacked bar.
...
- X-axis displays dates (days), Y-axis displays payment amounts
